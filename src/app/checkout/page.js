...
export default function checkout() {
    ...
    const publishableKey = 'pk_test_51Od0DnCdudMwjSgXNmVl7100cP4KBrjDZ3jrsDRAVE0qPBIV73tDmvC45O0ynAfhwEKJ15q71L8fLYWZp4i6iRG60034Cdw5IP';
                ...
                <div className="mx-auto mt-8 max-w-screen-xl- px-4 sm:px-6 lg:px-8">
                    <div className="bg-white shadow">
                        <div className="px-4 py-6 sm:px-8 sm:py-10 flex flex-col gap-5">
                            <h1 className="font-bold text-lg">Your payment is successful and you will be redirected to orders page within 2 seconds !</h1>
        ...
        <div>
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    <p className="text-xl font-medium">Shiiping Address Info</p>
                    <p className="text-gray-400 font-bold">Complete your order by selecting the address below</p>
